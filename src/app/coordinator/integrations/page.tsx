...
export default function IntegrationsPage() {
  ...
  return <div className="mx-auto max-w-5xl space-y-8">
    <PageHeader eyebrow={<span className="inline-flex items-center gap-2"><Settings2 className="size-4" />Phase 4 integrations</span>} title="Automated messaging" description="Test Mailjet delivery and connect Meta WhatsApp Cloud API for approved template messages." />
