...
export function EventRegistrationButton({ eventId, status, eligible=true, invited=false }: { eventId: string; status?: string; eligible?:boolean; invited?:boolean }) {
