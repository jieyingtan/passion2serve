...
export default async function ParticipantCalendarPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6">
      <div>
        <p className="text-sm font-semibold text-primary">Participant schedule</p>
        <h1 className="mt-1 text-2xl font-bold tracking-tight sm:text-3xl">{t.calendar.title}</h1>
